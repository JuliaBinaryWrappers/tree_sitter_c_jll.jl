# Autogenerated wrapper script for tree_sitter_c_jll for x86_64-w64-mingw32
...
const libtreesitter_splitpath = ["bin", "libtreesitter.dll"]
...
const libtreesitter = "libtreesitter.dll"


# Relative path to `libtreesitter_c`
const libtreesitter_c_splitpath = ["bin", "libtreesitter_c.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libtreesitter_c = "libtreesitter_c.dll"
