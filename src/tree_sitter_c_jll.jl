...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_c_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("af41be9f-6c08-5eeb-b278-7a4b044e283f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_c", artifacts_toml) for e in artifacts["tree_sitter_c"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_c; unsupported platform $(triplet(platform_key_abi()))")
else
